 ...
 *
 *   $Id: Wp_rssPage.java,v 1.3 2008/10/14 13:15:49 numiton Exp $
 *
 **********************************************************************************/
...
import org.numiton.nwp.wp_includes.Feed_rssPage;
...
@Controller
@Scope("request")
public class Wp_rssPage extends NumitonController {
	protected static final Logger	LOG	= Logger.getLogger(Wp_rssPage.class.getName());

	@Override
	@RequestMapping("/wp-rss.php")
	...
	public Object generateContent(PhpWebEnvironment webEnv) throws IOException, ServletException {
		...
		/* Start of block */
		super.startBlock("__wp_rss_block1");
		gVars.webEnv = webEnv;
		if (empty(gVars.wp)) {
			requireOnce(gVars, gConsts, Wp_configPage.class);
			getIncluded(FunctionsPage.class, gVars, gConsts).wp("feed=rss");
		}
		/* Condensed dynamic construct */
		require(gVars, gConsts, Feed_rssPage.class);
