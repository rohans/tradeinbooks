 ...
 *
 *   $Id: FooterPage.java,v 1.3 2008/10/14 13:15:48 numiton Exp $
 *
 **********************************************************************************/
...
public class FooterPage extends NumitonController {
    ...
    @Override
    @RequestMapping("/wp-content/themes/default/footer.php")
    ...
    public String getViewName() {
        return "wp_content/themes/_default/footer";
    }
    ...
    public Object generateContent(PhpWebEnvironment webEnv)
        ...
        /* Start of block */
        super.startBlock("__wp_content_themes__default_footer_block1");
        getIncluded(General_templatePage.class, gVars, gConsts).bloginfo("name");

        /* Start of block */
        super.startBlock("__wp_content_themes__default_footer_block2");
        getIncluded(General_templatePage.class, gVars, gConsts).bloginfo("rss2_url");

        /* Start of block */
        super.startBlock("__wp_content_themes__default_footer_block3");
        getIncluded(General_templatePage.class, gVars, gConsts).bloginfo("comments_rss2_url");

        /* Start of block */
        super.startBlock("__wp_content_themes__default_footer_block4");
        ...
        /* Start of block */
        super.startBlock("__wp_content_themes__default_footer_block5");
        getIncluded(Wp_settingsPage.class, gVars, gConsts).timer_stop(1);

        /* Start of block */
        super.startBlock("__wp_content_themes__default_footer_block6");
