 ...
 *
 *   $Id: SearchPage.java,v 1.3 2008/10/14 13:15:48 numiton Exp $
 *
 **********************************************************************************/
...
@Controller
@Scope("request")
public class SearchPage extends NumitonController {
    protected static final Logger LOG = Logger.getLogger(SearchPage.class.getName());

    @Override
    @RequestMapping("/wp-content/themes/default/search.php")
    ...
    public String getViewName() {
        return "wp_content/themes/_default/search";
    }

    public Object generateContent(PhpWebEnvironment webEnv)
        throws IOException, ServletException {
        /* Start of block */
        super.startBlock("__wp_content_themes__default_search_block1");
        gVars.webEnv = webEnv;
        getIncluded(General_templatePage.class, gVars, gConsts).get_header();

        /* Start of block */
        super.startBlock("__wp_content_themes__default_search_block2");
        ...
        if (getIncluded(QueryPage.class, gVars, gConsts).have_posts()) {
            ...
            /* Condensed dynamic construct: 253415 */ include(gVars, gConsts, SearchformPage.class);
            echo(gVars.webEnv, "\n\t");
        }

        /* Start of block */
        super.startBlock("__wp_content_themes__default_search_block3");
        getIncluded(General_templatePage.class, gVars, gConsts).get_sidebar(null);

        /* Start of block */
        super.startBlock("__wp_content_themes__default_search_block4");
