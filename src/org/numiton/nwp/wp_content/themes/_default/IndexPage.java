 ...
 *
 *   $Id: IndexPage.java,v 1.3 2008/10/14 13:15:48 numiton Exp $
 *
 **********************************************************************************/
...
@Controller(value = "wp_content/themes/_default/IndexPage")
@Scope("request")
public class IndexPage extends NumitonController {
    ...
    @Override
    @RequestMapping("/wp-content/themes/default/index.php")
    ...
    public String getViewName() {
        return "wp_content/themes/_default/index";
    }

    public Object generateContent(PhpWebEnvironment webEnv)
        throws IOException, ServletException {
        /* Start of block */
        super.startBlock("__wp_content_themes__default_index_block1");
        gVars.webEnv = webEnv;
        getIncluded(General_templatePage.class, gVars, gConsts).get_header();

        /* Start of block */
        super.startBlock("__wp_content_themes__default_index_block2");
        ...
        if (getIncluded(QueryPage.class, gVars, gConsts).have_posts()) {
            ...
            while (getIncluded(QueryPage.class, gVars, gConsts).have_posts()) {
                ...
                getIncluded(Post_templatePage.class, gVars, gConsts).the_content("Read the rest of this entry &raquo;", 0, "");
            ...
            /* Condensed dynamic construct: 253061 */ include(gVars, gConsts, SearchformPage.class);
            echo(gVars.webEnv, "\n\t");
        }

        /* Start of block */
        super.startBlock("__wp_content_themes__default_index_block3");
        getIncluded(General_templatePage.class, gVars, gConsts).get_sidebar(null);

        /* Start of block */
        super.startBlock("__wp_content_themes__default_index_block4");
