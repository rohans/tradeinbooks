 ...
 *
 *   $Id: LinksPage.java,v 1.3 2008/10/14 13:15:48 numiton Exp $
 *
 **********************************************************************************/
...
import org.numiton.nwp.wp_includes.Bookmark_templatePage;
...
@Controller
@Scope("request")
public class LinksPage extends NumitonController {
	protected static final Logger	LOG	= Logger.getLogger(LinksPage.class.getName());

	@Override
	@RequestMapping("/wp-content/themes/default/links.php")
	...
	public String getViewName() {
		return "wp_content/themes/_default/links";
	}
	...
	public Object generateContent(PhpWebEnvironment webEnv) throws IOException, ServletException {
		...
		/* Start of block */
		super.startBlock("__wp_content_themes__default_links_block1");
		...
		*/
		...
		/* Start of block */
		super.startBlock("__wp_content_themes__default_links_block2");
		getIncluded(Bookmark_templatePage.class, gVars, gConsts).wp_list_bookmarks();

		/* Start of block */
		super.startBlock("__wp_content_themes__default_links_block3");
